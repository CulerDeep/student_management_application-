...
class EditStudentForm(forms.Form):
    ...
    address=forms.CharField(label="Address",max_length=50,widget=forms.TextInput(attrs={"class":"form-control"}))
    course_list=(
                    ("B.E. Production Engineering","B.E. Production Engineering"),
                  ("M.E. Production Engineering","M.E. Production Engineering"),
                  ("M.E. Production Management","M.E. Production Management")
                        )
    #try:
     #   courses = Courses.objects.all()
     #   for course in courses:
    ...
    session_list = (('2021-2025','2021-2025'),
                    ('2021-202','2021-20235'))
    #try:
      #  sessions = SessionYearModel.object.all()
